...
describe('<Footer />', () => {
  ...
  it('should render the copyright text', () => {
    cy.contains('div', /Copyright © 2023 RideShare\s*-?\s*All Rights Reserved/).should('be.visible')
  })

  it('should render the social media images', () => {
    cy.get('img[src="/images/landing-page/footer/facebook.svg"]').should('be.visible')
    cy.get('img[src="/images/landing-page/footer/twitter.svg"]').should('be.visible')
    cy.get('img[src="/images/landing-page/footer/linkedin.svg"]').should('be.visible')
    cy.get('img[src="/images/landing-page/footer/instagram.svg"]').should('be.visible')
  })
