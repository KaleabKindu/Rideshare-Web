    ...
    <div className='flex flex-wrap gap-10 justify-evenly items-center p-5'>
        ...
        <div className='flex flex-col items-center gap-5'>
            ...
            <div className='flex gap-4 items-center'>
                <div className={`text-2xl text-white font-semibold ${roleColors[role].color}  rounded-full px-5 py-1`}>
        ...
        <div className='w-96 bg-gray-100 space-y-3 rounded-2xl p-8'>
            ...
            {role === 'driver' &&
            <div className='flex gap-4 items-center'>
                <RiRadioButtonLine size={20} className={`${statusColors[status].icon}`}/>
                <div className={`${statusColors[status].color} font-bold bg-opacity-20 rounded-full px-5 py-1`}>
