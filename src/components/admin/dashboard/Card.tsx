...
const Card = ({Icon, name, numberOfItems, increase, percentage}: CardProps) => {
  return (
    <div className='bg-white shadow-lg rounded-lg p-6 w-52 space-y-2 border '>
        ...
        <div className='flex justify-between gap-5'>
            ...
            <div className={`flex items-center ${increase ? 'text-green-500':'text-red-500'}`}>
                {increase ? <MdArrowDropUp size={20} />:<MdArrowDropDown size={20} />}
