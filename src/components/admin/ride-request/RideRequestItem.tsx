...
const RideRequestItem: React.FC<RideRequestProps>= ({name, origin, destination, currentFare, numberOfSeats, status, dateTime}) => {
  ...
  return (
      ...
      <tr>
                ...
                <td className="px-7 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{currentFare}</td>
                ...
                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{dateTime}</td>
