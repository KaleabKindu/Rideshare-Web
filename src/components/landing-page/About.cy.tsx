...
describe("About component", () => {
  ...
  it("should render the title", () => {
    cy.get('[data-cy="title"]').contains("Who are we?").should("be.visible");
  });
  ...
  it("should render the about text", () => {
    cy.get('[data-cy="about-text"]').contains(
  ...
  it("should render the vision text", () => {
    cy.get('[data-cy="vision-text"]').contains("Vision").should("be.exist");
    cy.get('[data-cy="vision-description"]').contains(
  ...
  it("should render the mission text", () => {
    cy.get('[data-cy="mission-text"]').contains("Mission").should("be.exist");
    cy.get('[data-cy="mission-description"]').contains(
